...
//PARTE PARA LA MANIPULACION Y MOSTRAR LA PARTE DE LOS DEPARTAMENTOS.    
...
//MOSTRAR O OCULTAR LA PARTE DE LOS TERMINOS Y CONDICIONES
...
//FUNCOINES PARA LA VALIDACION QUE EL TELEFONO SOLO ACEPTE HASTA 8 DIGITOS
...
//EL TELEFONO PARA QUE SOLO ACEPTE NUMEROS TECLEADOS
...
//FUNCION PARA VALIDAR LA PARTE DE CORREO CON LA REGULAR EXP
...
//FUNCION PARA VALIDAR AL CONTRASENIA 
...
//FUNCION PARA VALIDAR LA CONFIRMACION DE LA CONTRASENIA
function Concontra() {
    let contra = $("#txt_contra").val();
...
//FUNCION PARA LA VALIDACION DEL CUI
function Validarcui() {
...
$("#btn_registrar").on("click",function(){
    ...
    if (aceptar_registro[0] == 1 && aceptar_registro[1] == 1 && aceptar_registro[2] == 1 && aceptar_registro[3] == 1 && aceptar_registro[4] == 1 && aceptar_registro[5] == 1) {
        ...
        administradores[administradores.length] = {
                administradores_id: administradores.length+1,
                nombre: nombre, 
                apellido: apellido,
                direccion: direccion,
                telefono: telefono,
